package techniders.eusopht.app.Fragments;
...
import techniders.eusopht.app.Activities.CustomGooglePlacesSearch;
import techniders.eusopht.app.Activities.HistoryActivity;
import techniders.eusopht.app.Activities.ShowProfile;
import techniders.eusopht.app.Helper.ConnectionHelper;
import techniders.eusopht.app.Helper.CustomDialog;
import techniders.eusopht.app.Helper.DataParser;
import techniders.eusopht.app.Helper.SharedHelper;
import techniders.eusopht.app.Helper.URLHelper;
import techniders.eusopht.app.Models.CardInfo;
import techniders.eusopht.app.Models.Driver;
import techniders.eusopht.app.Models.PlacePredictions;
import techniders.eusopht.app.R;
import techniders.eusopht.app.Retrofit.ApiInterface;
import techniders.eusopht.app.Retrofit.RetrofitClient;
import techniders.eusopht.app.TranxitApplication;
import techniders.eusopht.app.Utils.MapAnimator;
import techniders.eusopht.app.Utils.MyBoldTextView;
import techniders.eusopht.app.Utils.MyButton;
import techniders.eusopht.app.Utils.MyTextView;
import techniders.eusopht.app.Retrofit.ResponseListener;
import techniders.eusopht.app.Utils.Utilities;
...
//                    destination.setText(SharedHelper.getKey(context, "extend_address"));
    ...
    private void showChooser() {
        Intent intent = new Intent(getActivity(), techniders.eusopht.app.Activities.Payment.class);
